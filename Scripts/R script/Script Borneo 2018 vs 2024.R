...
ndvi_2018 <- rast("C:/Users/israe/OneDrive/Desktop/Portafolio Israel Vallejo Muñoz/Borneo Deforestation/NDVI_2018_Borneo.tif")
ndvi_2024 <- rast("C:/Users/israe/OneDrive/Desktop/Portafolio Israel Vallejo Muñoz/Borneo Deforestation/NDVI_2024_Borneo.tif")
ndvi_diff <- rast("C:/Users/israe/OneDrive/Desktop/Portafolio Israel Vallejo Muñoz/Borneo Deforestation/NDVI_Difference_2024_2018_Borneo.tif")
...
ggplot(ndvi_df) +
  ...
  coord_equal() +
  labs(title = "NDVI Change between 2018 and 2024 - Borneo",
       fill = "Vegetation Change") +
  theme_minimal()

# Save classified raster as GeoTIFF
writeRaster(ndvi_classes, "NDVI_change_classes_Borneo.tif", overwrite = TRUE)
...
# Inspecciona el raster de diferencia
